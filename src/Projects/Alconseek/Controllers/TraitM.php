...
trait TraitM
{
    // trait cant has constant.

    static $HAS_BUILD = '已生成, 数秒后生效!';
    static $HAS_REBUILD = '已平滑重建, 数秒后生效!';
    static $HAS_CLEAN_AND_REBUILD = '清空并重建完成, 数秒后生效!';
    static $HAS_CLEAN = '清空完成!';
    static $NOT_EXISTS = '项目不存在';
    static $NOT_SIGNIN = '未登陆';
